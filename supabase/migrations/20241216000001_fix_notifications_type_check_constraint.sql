-- Fix notifications type check constraint to include all valid notification types
-- This migration updates the check constraint to allow all notification types used in the application
...
IS 'Ensures notification type is one of the valid types used in the application';
